...
- Disabled the '**Sorting Button**' from '**InvTweaks**' to prevent button overlapping in different GUIs. (**It's now Keybind only. Default: Middle Mouse.**)
- Reduced the amount of hearts that is provided by '**Health Ring**'. 5 -> 3.
