...
**Yet another round of some mod updates. Enjoy!**
...
**Another round of some mod updates. Enjoy!**
...
**Quests**
- **Re-organized** the **quest chapter ordering**.
- Fixed a few **typos** in **some quests**.
- Some minor changes.
...
**Fixes**
- Some nasty crashes in **Flux Networks** has been fixed.
- And some more fixes within mod updates.
...
- **JEI** page buttons sometimes becoming massive for whatever weird reason.
- **Graves** not spawning sometimes when killed. (**Please turn on keepInventory gamerule!**) (**Currently Investigating**)
...
- [Enigmatic Legacy](https://www.curseforge.com/minecraft/mc-mods/enigmatic-legacy)
- [Polymorph](https://www.curseforge.com/minecraft/mc-mods/polymorph) (**Re-added.**)
...
**Changes**
- Modified the recipes for some gadgets in the mod '**Building Gadgets.**'
- The '**Enigmatic Amulet**' now provides a really small damage buff when equipped, (**+0.5 Damage**).
- The '**Sorting Button**' from '**InvTweaks**' has been disabled in all GUIs except inventory to prevent button overlapping in different GUIs. (**Keybind still works in other GUIs. Default: Middle Mouse.**)
- Reduced the amount of hearts that is provided by '**Health Ring**'. 5 -> 2.
- The '**Wither Ring**' is now **Legendary**(**3**) tier.
- Rings from '**Rings of Ascension**' can no longer be found in '**Abandoned Mineshafts**'' minecart chests.
- Rings from '**Rings of Ascension**' can no longer be found in '**Village**'' chests.
- Added a recipe to the '**Enrichment Chamber**' from '**Mekanism**' for '**Certus Quartz Dust**'.
- Added a recipe to the '**Crusher**' from '**Silent's Mechanisms**' for '**Certus Quartz Dust**'.
- Added multiple new '**Ore Crushing Hammer**' recipes.
- Added some missing/new '**IE Hammer**' recipes.
- Other changes within mod updates.
...
**Updated**
- Updated Forge to version '**32.0.108**''
- All mods in the pack have been updated. Except mods that would break something!
...
**Added**
- [Curious Elytra](https://www.curseforge.com/minecraft/mc-mods/curious-elytra) (+ [Caelus API](https://www.curseforge.com/minecraft/mc-mods/caelus) )
...
- [Exp Ore](https://www.curseforge.com/minecraft/mc-mods/exp-ore-block-mod) (**Tweaked!**)
- [FPS Reducer](https://www.curseforge.com/minecraft/mc-mods/fps-reducer)
- [Farming for Blockheads](https://www.curseforge.com/minecraft/mc-mods/farming-for-blockheads)
- [Fast Furnace - Replacement ](https://www.curseforge.com/minecraft/mc-mods/fast-furnace-minus-replacement)
- [Fast Workbench - Replacement](https://www.curseforge.com/minecraft/mc-mods/fastworkbench-minus-replacement)
- [Grid](https://www.curseforge.com/minecraft/mc-mods/grid)
- [Industrial Reborn](https://www.curseforge.com/minecraft/mc-mods/industrial-reborn) (**Ore-Gen Tweaked!**)
- [Useful Backpacks](https://www.curseforge.com/minecraft/mc-mods/useful-backpacks) (+ [U Team Core](https://www.curseforge.com/minecraft/mc-mods/u-team-core) )
...
**Removed**
- [Look At That](https://www.curseforge.com/minecraft/mc-mods/look-at-that) (**Replaced by TOP.**)
- [Decorative Blocks](https://www.curseforge.com/minecraft/mc-mods/decorative-blocks)


**Changes**
- Increased the Max Distance in which you can random teleport, from 50k to 85k blocks. ( **/rndtp** ) (**Ma-Essentials.**)
- Lowered the cooldown of the '/rndtp' command, 600s -> 180s. (**Ma-Essentials.**)
- Minor changes within mod updates.


**Updated**
- Updated Forge to version 32.0.59!
- Any mod that had an update available, that also didn't break things.
